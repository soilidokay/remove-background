...
def calculate_bounding_box_around_longest_straightest_vertical_lines(image_path, output_path=None, min_line_length=50, max_line_gap=50, angle_tolerance=10, debug=True):
    """
    ...
    edges = cv2.Canny(blurred, 20, 75, apertureSize=3)
    if debug:
...
for i in range(start, count):
    calculate_bounding_box_around_longest_straightest_vertical_lines(f'images/{i}.png', f'outputs/{i}.jpg', debug=debug)
